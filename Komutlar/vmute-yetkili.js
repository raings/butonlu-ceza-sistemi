...
module.exports.config = { 
    name: 'ses-mute-yetkili-rol',
    aliases: ['s-m-y-rol','ses-mute-yetkili-role']
}
...
.setColor("#006bff")
.setDescription(`
 <:barrl:879417882528849920> Yetkili Ses Mute Sorumlu **${mahorol}** Rolü Olarak Ayarlandı


`))

db.set(`sesmuteyetkilirol.${message.guild.id}`, mahorol.id)  
